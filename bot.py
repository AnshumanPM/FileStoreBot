            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("About Owner", callback_data="aboutdevs"),
...
@Bot.on_message((filters.document | filters.video | filters.audio | filters.photo | filters.sticker) & ~filters.chat(Config.DB_CHANNEL))
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact Me [ 𝑨𝒏𝒔𝒉𝒖𝒎𝒂𝒏𝑷𝑴 〄 ](https://telegram.me/AnshumanPM_2006)",
                                     disable_web_page_preview=True)
            return
        ...
        try:
            ...
            share_link = f"https://telegram.me/{Config.BOT_USERNAME}?start=AnshumanPM_{str_to_b64(file_er_id)}"
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact me [ 𝑨𝒏𝒔𝒉𝒖𝒎𝒂𝒏𝑷𝑴 〄 ](https://telegram.me/AnshumanPM_2006).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact me [𝑨𝒏𝒔𝒉𝒖𝒎𝒂𝒏𝑷𝑴 〄](https://telegram.me/AnshumanPM_2006).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
